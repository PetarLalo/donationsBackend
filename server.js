...
app.get("/api/empleados", (req, res) => {
  connection.query("SELECT * FROM empleados", (err, results) => {
    if (err) {
      return res
        .status(500)
        .json({ message: "Error al obtener empleados", error: err });
    }
    res.json(results);
  });
});
  ...
  connection.query(
    ...
    (err, results) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al obtener el empleado", error: err });
      }
  ...
  connection.query(
    ...
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al crear el empleado", error: err });
      }
...
app.put("/api/empleados/:id", (req, res) => {
  ...
  const query =
    "UPDATE empleados SET nombre = ?, apellido = ?, cargo = ?, telefono = ?, email = ? WHERE id = ?";
  connection.query(
    query,
    ...
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al actualizar el empleado", error: err });
      }
  ...
  connection.query(
    ...
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al eliminar el empleado", error: err });
      }
...
app.get("/api/donadores", (req, res) => {
  connection.query("SELECT * FROM donadores", (err, results) => {
    if (err) {
      return res
        .status(500)
        .json({ message: "Error al obtener donadores", error: err });
    }
    res.json(results);
  });
});
  ...
  connection.query(
    ...
    (err, results) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al obtener el donador", error: err });
      }
  ...
  connection.query(
    ...
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al crear el donador", error: err });
      }
...
app.put("/api/donadores/:id", (req, res) => {
  ...
  const query =
    "UPDATE donadores SET nombre = ?, apellido = ?, tipo = ?, telefono = ?, email = ? WHERE id = ?";
  connection.query(
    query,
    [nombre, apellido, tipo, telefono, email, id],
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al actualizar el donador", error: err });
      }
  ...
  connection.query(
    ...
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al eliminar el donador", error: err });
      }
...
app.get("/api/donaciones", (req, res) => {
  connection.query("SELECT * FROM donaciones", (err, results) => {
    if (err) {
      return res
        .status(500)
        .json({ message: "Error al obtener donaciones", error: err });
    }
    res.json(results);
  });
});
  ...
  connection.query(
    ...
    (err, results) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al obtener la donación", error: err });
      }
...
app.post("/api/donaciones", (req, res) => {
  ...
  const query =
    "INSERT INTO donaciones (donador_id, tipo, descripcion, cantidad, fecha) VALUES (?, ?, ?, ?, ?)";
  connection.query(
    query,
    [donador_id, tipo, descripcion, cantidad, fecha],
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al crear la donación", error: err });
      }
...
app.put("/api/donaciones/:id", (req, res) => {
  ...
  const query =
    "UPDATE donaciones SET donador_id = ?, tipo = ?, descripcion = ?, cantidad = ?, fecha = ? WHERE id = ?";
  connection.query(
    query,
    [donador_id, tipo, descripcion, cantidad, fecha, id],
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al actualizar la donación", error: err });
      }
  ...
  connection.query(
    ...
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al eliminar la donación", error: err });
      }
...
app.get("/api/inventario", (req, res) => {
  connection.query("SELECT * FROM inventario", (err, results) => {
    if (err) {
      return res
        .status(500)
        .json({ message: "Error al obtener el inventario", error: err });
    }
    res.json(results);
  });
});
  ...
  connection.query(
    ...
    (err, results) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al obtener el item", error: err });
      }
...
app.post("/api/inventario", (req, res) => {
  ...
  connection.query(
    query,
    [nombre, categoria, cantidad, descripcion, ubicacion],
    (err, result) => {
      if (err) {
        return res
          .status(500)
          .json({ message: "Error al crear el item", error: err });
      }
...
app.put("/api/inventario/:id", (req, res) => {
  ...
  const query =
    "UPDATE inventario SET nombre = ?, categoria = ?, cantidad = ?, descripcion = ?, ubicacion = ? WHERE id = ?";
  connection.query(
    query,
    [nombre, categoria, cantidad, descripcion, ubicacion, id],
    (err, result) => {
      if (err) {
        return res
          .status(500)
